...
describe('ImageAnimation', () => {
  it('Does ImageAnimation have the initial values', (done) => {
    ...
    assert.deepEqual(ImageAnimation.data(), defaultData, 'Match default properties')
  ...
  it('Should be possible to stop image frames - no anim key', (done) => {
    ...
    assert.isFalse(imageAnimation.vm.stopImageFrame(), 'should have bailed out early')
  ...
  it('Should be possible to stop image frames', (done) => {
    ...
    assert.isTrue(imageAnimation.vm.timerAnimation === -1, 'timeranimation id should have become -1')
  ...
  it('Should be possible to play image frames the imageFrame', (done) => {
    ...
    assert.isTrue(imageAnimation.vm.timerAnimation !== -1, 'timeranimation id should not be -1')
  ...
  it('Should be possible to play image frames the imageFrame - No animationkey set', (done) => {
    ...
    assert.isTrue(imageAnimation.vm.timerAnimation === -1, 'timeranimation id should still be -1')
  ...
  it('Should be possible to change to next imageFrame', (done) => {
    ...
    imageAnimation.vm.model.info = { delta_fringe_images: { files: ['firstframe.jpg', 'lastframe.jpg'] } }
    ...
    assert.isTrue(imageAnimation.vm.animationIndex === 1, 'Animation frame at 1')
  ...
  it('Should be possible to change to next imageFrame - stop at end', (done) => {
    ...
    // Next frame should have brought to the next frame.
    assert.isTrue(imageAnimation.vm.animationIndex === imageAnimation.vm.model.info.delta_fringe_images.files.length - 1, 'Animation frame at end')
  ...
  it('Should be possible to change to next imageFrame - no model info', (done) => {
    ...
    assert.isTrue(imageAnimation.vm.currentAnimationIndex === 0, 'Animation index should stay 0')
  ...
  it('Should be possible to check hasFrames property', (done) => {
    ...
    assert.isTrue(imageAnimation.vm.hasFrames === true, 'Animation does not have frames')
    done()
  })
  ...
  it('Should be possible to check animationIndex property', (done) => {
    ...
    assert.isTrue(imageAnimation.vm.animationIndex === 0, 'Animation frame at 0')
    done()
  })
  ...
  it('Should be possible to check animationFrame property', (done) => {
    const imageAnimation = shallowMount(ImageAnimation)
    /* eslint-disable camelcase */
    imageAnimation.vm.model.info = { delta_fringe_images: { location: 'location/', files: ['firstframe.jpg', 'lastframe.jpg'] } }
    /* eslint-enable camelcase */
  ...
  it('Should be possible to check frameCount property', (done) => {
    ...
    /* eslint-enable camelcase */
    imageAnimation.vm.currentAnimationKey = 'delta_fringe_images'
    assert.isTrue(imageAnimation.vm.frameCount === imageAnimation.vm.model.info.delta_fringe_images.files.length, 'Animation framecount should not be 0')
    done()
  })
  ...
  it('Should be possible to check frameCount property - no data', (done) => {
    ...
    /* eslint-enable camelcase */
    imageAnimation.vm.currentAnimationKey = 'delta_fringe_images'
    assert.isTrue(imageAnimation.vm.frameCount === 0, 'Animation framecount should not be 0')
    done()
  })
  ...
  it('Should be possible to previousImageFrame - No model info', (done) => {
    ...
    assert.equal(imageAnimation.vm.animationIndex, 1, 'Animation frame should still have been one.')
    done()
  })
  ...
  it('Should not be possible to previousImageFrame before 0', (done) => {
    ...
    // index should become 0
    /* eslint-disable camelcase */
    imageAnimation.vm.model.info = { delta_fringe_images: { files: ['firstframe.jpg', 'middleframe.jpg', 'lastframe.jpg'] } }
    /* eslint-enable camelcase */
    imageAnimation.vm.switchAnimation('delta_fringe_images')
    ...
    assert.equal(imageAnimation.vm.animationIndex, 0, 'Animation frame should not have wrapped')
    done()
  })
  ...
  it('Should be possible to gotoLastFrame', (done) => {
    ...
    assert.isTrue(imageAnimation.vm.animationIndex === imageAnimation.vm.model.info.delta_fringe_images.files.length - 1, 'Animation frame at 0')
    done()
  })
})
